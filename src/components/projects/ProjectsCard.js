...
const ProjectsCard = ({ title, des, src, github, website, figma }) => {
  return (
            ...
            <div className="flex gap-2">
              ...
              {figma && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-lg w-10 h-10 rounded-full bg-black inline-flex justify-center items-center hover:text-designColor duration-300"
